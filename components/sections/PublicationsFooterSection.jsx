...
import {
  FaGithub, FaLinkedinIn, FaInstagram, FaFacebookF, FaThreads, FaWhatsapp, FaEnvelope,
          ...
          <div ref={bottomBarRef} className={styles.bottomBar}>
            <div className={styles.bottomLeft}>
              <div className={styles.monogram}>
                <span className={styles.monoLetters}>SJ</span>
